...
var Carousel = function ($$$1) {
  ...
  function (_Helpers) {
    ...
    _proto._add = function _add() {
      ...
      var carousel = ClassName.CAROUSEL + "-" + id; // add otpion
      ...
      this._element.classList.add(ClassName.THEME, carousel); // init carousel


      return $$$1("." + carousel).owlCarousel({
...
var Lightbox = function ($$$1) {
  /**
   * ------------------------------------------------------------------------
   * Constants
   * ------------------------------------------------------------------------
   */
  var DATA = 'ya-lightbox';
  var DATA_KEY = "[" + DATA + "]";
  var VERSION = '1.0.0';
  var ClassName = {
    LIGHTBOX: DATA,
  ...
  function (_Helpers) {
    ...
    function Lightbox(element) {
      ...
      _this._data = element.getAttribute(DATA);
    ...
    _proto._add = function _add(src) {
      ...
      lightbox.backdrop.className = ClassName.BACKDROP; // add effect
    ...
    _proto._gallery = function _gallery(lightbox) {
      ...
      document.querySelectorAll(DATA_KEY + "[rel=" + this._rel + "]").forEach(function (el) {
      ...
      $$$1('.owl-carousel-theme').owlCarousel({
        loop: true,
        nav: true,
        items: 1
      });
    ...
    _proto._video = function _video(lightbox, src) {
      ...
      lightbox.embed.className = ClassName.IFRAME; // append iframe
...
var Navbar = function ($$$1) {
  ...
  function () {
    ...
    _proto._fix = function _fix() {
      $$$1('.dropdown-lg').on('hide.bs.dropdown', function () {
        document.querySelector('.owl-carousel').classList.add('owl-hide');
      });
      $$$1('.dropdown-lg').on('show.bs.dropdown', function () {
        document.querySelector('.owl-carousel').classList.remove('owl-hide');
      });
    };

    _proto._hover = function _hover() {
      $$$1('.dropdown > .dropdown-menu > .dropdown').hover(function () {
        $$$1(this).toggleClass('show');
      });
    }; // private
  ...
  */
  ...
  document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll(Selector.NAVBAR).forEach(function (el) {
